...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210105_terressecretes_c628fcb1078629f74054_20210527092021_archive.zip';
	const ARCHIVE_SIZE		 = '246184619';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c628fcb-27092021';
    const SECONDARY_PACKAGE_HASH = '78aa3ee-27092021';
	const VERSION			 = '1.4.1';
